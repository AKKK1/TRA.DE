...
export default function CategoriesPage() {
  ...
  // vehicles + realestate details details details — details grid-details
      ...
      <div className="max-w-[1100px] mx-auto px-4 py-10">
        ...
        <div className="mb-6">
          ...
          <p style={{ color: "#999", fontSize: 13 }}>
            {loading ? (
              ...
              <>
                total <strong style={{ color: GOLD }}>{total}</strong> Listing
                All CategoryText
              </>
            )}
          </p>
        ...
        >
          ...
          <p style={{ fontSize: 12, color: "#999", marginBottom: 16 }}>
            Legal documents help protect both sides
          </p>
          ...
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
            {[
              ...
              // },
              {
                ...
                icon: "💼",
                label: "Trade a service for an item",
                catId: "serviceToThing",
              },
              {
                href: "/category/thingToService",
                icon: "🎯",
                label: "Trade an item for a service",
