...
const adZones = [
  ...
  },
  {
    id: "vip-carousel",
    name: "VIP carousel",
    location: "Home page — VIP section",
    size: "260×350px",
    price: "€400 / month",
    views: "~30,000 views/month",
    description: "Advertising placement",
    badge: "POPULAR",
    highlight: false,
  },
  {
    id: "sidebar",
    name: "Side banner",
    location: "Advertising placement",
    size: "300×600px",
    price: "€300 / month",
    views: "~20,000 views/month",
    description: "Targeted category traffic.",
    badge: null,
    highlight: false,
  },
  {
    id: "listing-inline",
    name: "Advertising placement",
    location: "Main feed — every eighth slot",
    size: "Full card",
    price: "€400 / month",
    views: "~15,000 views/month",
    description: "Native placement inside the listing feed.",
    badge: null,
    highlight: false,
  },
  {
    id: "mobile-banner",
    name: "Mobile banner",
    location: "Mobile — below navigation",
    size: "360×60px",
    price: "€500 / month",
    views: "~25,000 views/month",
    description: "Designed for mobile-heavy traffic.",
    badge: "MOBILE",
    highlight: false,
  },
];
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          >
            ad ad
            <br />
            <span style={{ color: C.green }}>ad</span>
          </h1>
          <p
            className="text-sm leading-relaxed mb-8 max-w-xl"
            style={{ color: C.text2 }}
          >
            10,000+ User daily. Germany All ad
            ad ad ad — ad ad ad.
          </p>
          <div className="flex flex-wrap gap-4">
            {[
              { label: "10,000+", sub: "Daily visitors" },
              { label: "70%", sub: "Mobile" },
              { label: "18–45", sub: "Target audience" },
            ].map((s, i) => (
              <div
                key={i}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {adZones.map((zone) => (
              ...
              >
                ...
                <a
                  href="mailto:gamitsvale@gmail.com?subject=Advertising placement"
      ...
      >
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-sm mb-8" style={{ color: C.text2 }}>
            ad terms, ad 3+ monthText — ad.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              href="mailto:gamitsvale@gmail.com?subject=Advertising"
