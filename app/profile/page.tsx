...
function ProfilePageContent() {
  ...
  const contactButtons = (offer: any, otherParty: any) =>
    [
      {
        key: "phone",
        label: "Phone",
        ...
        tone: C.green,
        background: "#ffffff",
        action: () => handleCopy(`${offer._id}-phone`, otherParty.phone),
        copiedLabel: "Copied",
      },
      {
        key: "telegram",
        ...
        tone: "#229ED9",
        background: "#eef8fe",
        action: () => openChat("telegram", otherParty.telegram),
        copiedLabel: "",
      },
      {
        key: "whatsapp",
        ...
        tone: "#16a34a",
        background: "#effaf3",
        action: () => openChat("whatsapp", otherParty.whatsapp),
        copiedLabel: "",
      },
    ...
    >
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        >
          ...
          <span style={{ color: C.text, fontWeight: 600 }}>Profile</span>
        </div>
          ...
          <div className="space-y-4">
            ...
            >
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(26,138,74,0.12), rgba(255,255,255,0.92) 58%, rgba(200,130,10,0.08))",
                ...
                <div className="relative group">
                  <div
                    ...
                    style={{
                      ...
                      color: C.green,
                      boxShadow: "0 0 0 1px rgba(26,138,74,0.18), 0 10px 24px rgba(26,138,74,0.16)",
                    }}
                  >
                    {user.avatar ? (
                      <img
              ...
              <div className="grid grid-cols-1 gap-2">
                {[
                  ...
                  user.whatsapp && {
                    icon: (
                      <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-white">
                        <FaWhatsapp className="h-4 w-4 text-[#16a34a]" />
                      </span>
                    ),
                    label: "WhatsApp",
                  ...
                  .map((item: any, i) => (
                    <div
                      key={i}
                      className="flex min-h-[42px] items-center gap-3 rounded-xl px-3 py-2 text-sm"
                      style={{
                        background: item.bg,
              ...
              <button
                ...
                className="m-5 mt-4 flex w-[calc(100%-40px)] items-center justify-center gap-1.5 rounded-lg py-2 text-xs font-medium transition-all"
                style={{
                  border: `1px solid ${C.border}`,
                  color: C.text2,
                            ...
                            {offer.status === "ACCEPTED" && (
                              ...
                              >
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                                  {contactButtons(offer, otherParty).map(
                                    (item) => (
                                      <button
                                        key={`${offer._id}-${item.key}`}
                                        type="button"
                                        onClick={item.action}
                                        className="group flex min-h-[62px] items-center gap-3 rounded-xl px-3 py-2 text-left transition-all"
                                        style={{
                    ...
                    <form
                      ...
                      onSubmit={async (e) => {
                        ...
                        if (res.ok) {
                          ...
                          setSettingsError(err.error || "Error");
                        }
                      }}
                    >
                      {/* username */}
                      <div className="space-y-1.5">
                        ...
                        <p
                          ...
                          style={{ color: C.text3 }}
                        >
                          Shown on cards instead of your full name
                        </p>
                      </div>
                  ...
                  {user.role === "ADMIN" && siteSettings && (
                    ...
                    >
                      <h4
                        ...
                        style={{ color: C.text3 }}
                      >
                        <Globe size={13} style={{ color: C.green }} /> Site
                        Settings
                      </h4>
                      <form
                        className="space-y-4 max-w-md"
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p
                      ...
                      style={{ color: C.text }}
                    >
                      Payment system is not integrated yet
                    </p>
                    <p
                      className="text-xs leading-relaxed"
                      style={{ color: C.text2 }}
                    >
                      Manual transfers are currently handled by bank transfer.
                      Add your email in the payment description.
                    </p>
                  </div>
                </div>
              </div>
