...
// ❌ edge runtime details — Buffer details details edge-details
export const alt = "TRA.DE";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

const APP_URL = process.env.APP_URL || "https://TRA.DE";
...
export default async function Image({
  ...
  const city = listing?.city || "Germany";
  ...
  // Cloudinary URL details — Node runtime-details details details details
