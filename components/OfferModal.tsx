        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
          <div>
            <h2 className="text-lg font-black text-gray-900">
              offer <span className="text-green-600">Trade</span>
            </h2>
          ...
          {!success && (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  { label: "Details", value: "3 offer" },
                  { label: "Daily limit", value: "15 offer" },
                ].map((item) => (
                  <div
                    key={item.label}
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Describe what you are offering in return..."
                  value={description}
